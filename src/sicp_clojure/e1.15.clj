...
;; First we require math to get access to abs
;; Also need to add the dependency in project.clj file
(require ['clojure.math.numeric-tower :as 'math])

;; Now we can proceed with the re-writing in clojure
(defn cube [x] (* x x x))
...
;; (p (p (p 0.4351345505)))
;; (p (p (- (* 3 0.4351345505) (* 4 (cube 0.4351345505))))))
;; (p (p 0.9758465331678772))
;; (p (- (* 3 0.9758465331678772) (* 4 (cube 0.9758465331678772))))
;; (p -0.7895631144708228)
;; (- (* 3 -0.7895631144708228) (* 4 (cube -0.7895631144708228)))
;; -0.39980345741334
(= -0.39980345741334 (sine 12.15))
;;
;;
